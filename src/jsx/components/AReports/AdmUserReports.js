...
const CourseBlogData = [
	{ coloumClass:'col-sm-6',classChange:'bg-info', image: Book, imgClass:'',	title: 'Learners', number:'2', svgicon: <MyIcon />, },
	{ coloumClass:'col-sm-6',classChange:'bg-info', image: Bookmarks,	imgClass:'bookmarks', title: 'Course Assigments', number:'0', svgicon: <BookIcon /> },
	{ coloumClass:'col-sm-6',classChange:'bg-info', image: Check, imgClass:'',	title: 'Completed Courses', number:'0', svgicon: <RightIcon /> },
...
const AdmUserReports = () => {
  ...
  return (
    <Fragment>
      <Row>
        <Col lg={12}>
          <Card>
            <Card.Header>
              <Card.Title>User Reports</Card.Title>
            </Card.Header>
            <Card.Body>
            <div className="row">
    ...
    {CourseBlogData.map((item, ind)=>(
      <div className={`col-xl-2 col-xxl-2 ${item.coloumClass}`} key={ind} >
          ...
          <img src={item.image} alt="" className={item.imgClass} />
              ...
              <Table responsive striped bordered className="verticle-middle">
                ...
                <tbody>
                  <tr>
                    <td>
                    <center><Link to="/ad-user-progress"><strong>Hitesh</strong></Link></center>
                    </td>
                  ...
                  <tr>
                    <td>
                    <center><Link to="/ad-user-progress"><strong>Rushi</strong></Link></center>
                    </td>
                    <td><center>Active</center></td>
                    <td><center>100</center></td>
                    <td><center>50</center></td>
