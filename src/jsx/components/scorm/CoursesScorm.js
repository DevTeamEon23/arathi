...
var filename = "1681447333/story.html";
  ...
  const fetchData = () => {
    fetch(`http://localhost:8000/scorm/story.html`)
    .then((res) => res.json())
    .then((data) => {
       console.log(data);
       setData(data);
      ...
      <Row>
        <Col lg={12}>
          <Card>
            ...
            {/* <form > */}
            {/* <iframe src="http://drive.google.com/file/d/1sbNypqGVZSVNxxdbmAWjRx2119O3hfFk/preview" width="640" height="480" allow="autoplay"></iframe> */}
              {/* /// Uncomment this below line
            // src="http://drive.google.com/file/d/1sbNypqGVZSVNxxdbmAWjRx2119O3hfFk/preview" */}

            {/* </form>  */}
            <form action="http://127.0.0.1:8000/scorm" method="GET" enctype="application/x-www-form-urlencoded">
            <video width="960" height="500" controls muted="muted">
                ...
                <iframe src={`http://127.0.0.1:8000/scorm`} width="640" height="480" type="video/mp4" allow="autoplay"></iframe> */}
                   <source src="http://127.0.0.1:8000/scorm/story.html" width="640" height="480" allow="autoplay"/>
                   </video>
                  {/* /// Uncomment this below line
                  src="http://drive.google.com/file/d/1sbNypqGVZSVNxxdbmAWjRx2119O3hfFk/preview" */}
