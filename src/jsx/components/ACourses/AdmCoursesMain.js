...
const AdmCoursesMain = () => {
	...
	const fetchData = () => {
		...
		fetch('https://localhost:8000/photo/${filename}', {
			method: 'GET',
		})
	...
	return(
		<>
			<div className="widget-heading d-flex justify-content-between align-items-center">
				...
				<Link to={"./adm_course-details-1"} className="btn btn-primary btn-sm">View all</Link>
			</div>
			<div className="row">
							...
							<div className="card-body">
								<div className="courses-bx">
									...
									{/* {"media/Famous-Fort-Maharashtra.png;base64,${data.file[0]}"} */}
										<img src="https://localhost:8000/photo/${filename}" width="250" height="250" id="myImage" name="file"/>
									</div>
									<div className="dlab-info">
										<div className="dlab-title d-flex justify-content-between">
											<div>
												<h4><Link to={"./adm_course-details-1"}>{item.coursename}</Link></h4>
			...
			<div className="pagination-down">
				<div className="d-flex align-items-center justify-content-between flex-wrap">
					...
					<ul>
						<li><Link to={"./adm_courses"} className="active">1</Link></li>
						<li><Link to={"./adm_course-details-1"}>2</Link></li>
						<li><Link to={"./adm_course-details-2"}>3</Link></li>
						<li><Link to={"./adm_course-details-1"}><i className="fas fa-chevron-right"></i></Link></li>
					</ul>
				</div>
			</div>
		</>
