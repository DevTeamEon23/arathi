				...
				<div className="col-xl-8 col-xxl-7 col-lg-12 ">
					<div className="row">
						...
						<div className="widget-heading d-flex justify-content-between align-items-center">
							...
							<Link to={"./courses"} className="btn btn-primary btn1">View all</Link>
							<Button 
							className="btn btn-primary btn2"
							onClick={handleExport} >Export in Excel</Button>
						</div>
						{/* <div className="row">
								...
								<div className="course-details-tab style-2 mb-2">
									<nav>
										<Nav as='div' className="nav nav-tabs tab-auto" id="nav-tab">
											<Nav.Link as='button' className="nav-link" id="nav-about-tab" eventKey='About' type="button">Points</Nav.Link>
											<Nav.Link as='button' className="nav-link" id="nav-reviews-tab" eventKey='Review' type="button">Levels</Nav.Link>
											<Nav.Link as='button' className="nav-link" id="nav-discussion-tab" eventKey='Discussion' type="button">Badges</Nav.Link>
										</Nav>
									</nav>
									<Tab.Content className="tab-content" id="nav-tabContent">
										<Tab.Pane  id="nav-about" eventKey='About'>
											<div className="about-content">
												...
												<h6>💎 Each successful test completion gives 1 point   &nbsp;  < i class="bi bi-info-circle-fill"></i></h6>
												<h6>💎 Each successful assignment completion gives 1 point    &nbsp;< i class="bi bi-info-circle-fill"></i></h6>
												<h6>💎 Each successful ILT completion gives 1 point   &nbsp; < i class="bi bi-info-circle-fill"></i></h6>
												<h6>💎 Each discussion topic or comment gives 25 points</h6>
												<h6>💎 Each upvote on discussion comments gives 10 points</h6>
												</div>
