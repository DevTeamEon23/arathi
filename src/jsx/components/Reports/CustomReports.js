...
const CourseBlogData = [
	{ coloumClass:'col-sm-6',classChange:'bg-secondary', image: Check, 	imgClass:'',	 title: 'Courses', number:'1', svgicon: <RightIcon />, },
            ...
            <img src={item.image} alt="" className={item.imgClass} />
              ...
              <Table responsive striped bordered className="verticle-middle">
                ...
                <tbody>
                  <tr>
                    <td>
                      <strong>Advanced Features of LMS</strong>
                    </td>
                    <td>100</td>
                    <td>50</td>
                    <td>25</td>
                    ...
                    <td>40</td>
                    <td>10</td>
                    <Link to="/reports-overview"><td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<i class="bi bi-graph-up"></i></td></Link>
