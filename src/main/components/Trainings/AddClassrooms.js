...
const AddClassrooms = () => {
  ...
  const handleSubmit = (e) => {
    ...
    const data = {id,instname,classname,date, starttime, venue, messg, duration};
        ...
        <div className="col-lg-12">
          <div className="card">
            ...
            <div className="card-body">
              ...
              <form action="https://localhost:8000/classrooms" method="post" encType="multipart/form-data" >
                  <div className="row">
