...
const AdExportUser = () => {
        ...
        const fetchData = () => {
          fetch(`http://3.110.173.183/users/`)
  ...
  return (
    ...
    <Nav >
        ...
        <Link as="button" className="nav-link  nt-unseen" id="nav-following-tab" eventKey='Follow' type="button" to="/a-users-list">Users List</Link>
        <Link as="button" className="nav-link  nt-unseen" id="nav-following-tab" eventKey='Follow' type="button" to="/ad-import-user">Import File</Link>
        </Nav.Item>
    </Nav>
    <div className="row">
