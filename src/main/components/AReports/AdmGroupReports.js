...
const GroupBlogData = [
	{ coloumClass:'col-sm-6',classChange:'bg-info', image: Book, imgClass:'',	title: 'Groups', number:'2', svgicon: <MyIcon />, },
	{ coloumClass:'col-sm-6',classChange:'bg-info', image: Bookmarks,	imgClass:'bookmarks', title: 'Assigned users', number:'0', svgicon: <BookIcon /> },
	{ coloumClass:'col-sm-6',classChange:'bg-info', image: Check, imgClass:'',	title: 'Assigned courses', number:'0', svgicon: <RightIcon /> },
	{ coloumClass:'col-sm-6',classChange:'bg-info', image: Progress,	imgClass:'', title: 'Completed courses', number:'0', svgicon: <ProgressIcon /> },
	{ coloumClass:'col-sm-6',classChange:'bg-info', image: Bulb, imgClass:'bulb',	title: 'Course in progress', number:'0h0m', svgicon: <BulbIcon /> }
];

const AdmGroupReports = () => {
    ...
    <Fragment>
      <Row>
        <Col lg={12}>
          <Card>
            <Card.Header>
              <Card.Title>Group Reports</Card.Title>
            </Card.Header>
            <Card.Body>
            <div className="row">
              <div className="col-lg-1">
            </div>
    {GroupBlogData.map((item, ind)=>(
              ...
              <Table responsive striped bordered className="verticle-middle">
                <thead>
                  <tr>
                    ...
                    <th>
                      <strong><center>NUMBER OF USERS</center></strong>
                    </th>
                    <th>
                      <strong><center>NUMBER OF TRAINING</center></strong>
                    </th>
                  </tr>
                </thead>
                <tbody>
                  <tr>
                    <td>
                      <center>
                      <Link to="/adm_course_overview"><strong>Hitesh</strong></Link>
                      </center>
                    </td>
...
export default AdmGroupReports;