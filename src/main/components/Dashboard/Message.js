...
import contact1 from '@images/contacts/pic-333.jpg';
import contact2 from '@images/contacts/pic444.jpg'; 
import contact3 from '@images/contacts/pic555.jpg';
import contact4 from '@images/contacts/pic-333.jpg';
import contact5 from '@images/contacts/pic666.jpg'; 
import contact6 from '@images/contacts/pic444.jpg'; 



import courses1 from '@images/courses/pic1.jpg';
import courses2 from '@images/courses/pic2.jpg';
import courses3 from '@images/courses/pic3.jpg';
import courses4 from '@images/courses/pic4.jpg';
import courses5 from '@images/courses/pic5.jpg';
import courses6 from '@images/courses/pic6.jpg';
...
const chatBoxBlog = [
	{title:'Tony Soap', image:courses2},
	{title:'Karen Hope', image:courses3},
	{title:'Tony Soap', image:courses6},
	{title:'Karen Hope', image:courses5},
	{title:'Tony Soap', image:courses4},
	{title:'Karen Hope', image:courses1},
];


const sharedFileBlog = [
	{},
	{},
	{},
	{},
	...
	return(
		<>
			<div className="row">
									...
									<div className="course-details-tab style-2">
										<nav>
											<Nav as='div' className="nav nav-tabs">
												<Nav.Link as='button' eventKey='Private' className="nav-link">Private</Nav.Link>
												<Nav.Link as='button' eventKey='Group' className="nav-link">Group</Nav.Link>
										  </Nav>
										</nav>
										<Tab.Content >
											<Tab.Pane  eventKey='Private'>							
												<ul>
													{chatBoxBlog.map((item, ind)=>(
														<li className="chat-bx" key={ind}>
				...
				<div className="col-xl-5 chat-mid-area">
					<div className="message-box style-1 d-flex align-items-center">
						<img src={courses2} alt="" />
						<div className="ms-3 flex-1">
							<h4>Karen Hope</h4>
							<span>
								<svg className='me-1' width="8" height="9" viewBox="0 0 8 9" fill="none" xmlns="http://www.w3.org/2000/svg">
					...
					<PerfectScrollbar className="chat-box-area dlab-scroll" >
					...
					<div className="type-massage">
						<div className="input-group">
							...
							<div className="input-group-append">
								...
								<button type="button" className="btn btn-secondary rounded text-white">
									<svg className="" width="20" height="20" viewBox="0 0 25 24" fill="none" xmlns="http://www.w3.org/2000/svg">
				...
				<div className={`col-xl-3 chat-right-area col-md-6 ${messageList ? 'active': '' }`}>
					<Link to={"#"} className={`chat-rightarea-btn  ${messageList ? 'active': '' }`}
						onClick={()=>setMessageList(!messageList)}><i className="fas fa-chevron-left"></i>
					</Link>
					<div className="card share-widget " id="share-widget">
						<PerfectScrollbar className="dlab-scroll">
							<div className="card-body">
								...
								<div className="share-files">
									<div className="widget-heading d-flex justify-content-between mt-4">
										<h4 className="m-0 fs-18 font-w600">Shared Files</h4>
										<Link to={"#"} className="btn-link text-primary fs-14 ">View all</Link>
									</div>
									<ul className="file-list">
										{sharedFileBlog.map((item, ind)=>(
											<li key={ind}>
												<div className="d-flex align-items-center">
													...
													<div className="ms-2 fl-info">
														<h4 className="m-0 fs-14 font-w600">File.doc</h4>
														<span>2 March 2021, 13:45 PM</span>
													</div>
												</div>
												<h4 className="m-0 fs-14 font-w600">1,5 Mb</h4>
											</li>
										))}
									</ul>
								</div>
								<div className="share-files">
									<div className="widget-heading  d-flex justify-content-between mt-4">
										<h4 className="m-0 fs-18 font-w600">Shared Links</h4>
										<Link to={"#"} className="btn-link text-primary fs-14 ">View all</Link>
									</div>
									<ul className="file-list">
										{SharedLinks.map((data, ind)=>(
											<li key={ind}>
												<div className="d-flex align-items-center">
													<span className="file">
														<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
													...
													<div className="ms-2 fl-info">
														<h4 className="m-0 fs-14 font-w600">{data.title}</h4>
														<span>2 March 2021</span>
													</div>
												</div>
												<h4 className="m-0 fs-14 font-w400">13:45 PM</h4>
											</li>
										))}										
