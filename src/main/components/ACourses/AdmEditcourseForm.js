  ...
  const handleAddFormSubmit = (event) => {
    ...
    if (!error) {
      ...
      addFormData.coursename =
        addFormData.addcoursephoto =
        addFormData.description =
        addFormData.hidecourse =
        addFormData.coursecode =
        addFormData.coursevideolink =
        addFormData.coursevideofile =
        addFormData.capacity =
        addFormData.coursedate =
        addFormData.coursetime =
        addFormData.certificate =
        addFormData.level =
        addFormData.instname =
        addFormData.parentcategory =
        addFormData.lastprice =
          "";
    } else {
                              ...
                              <div className="form-group mb-3 row">
                                <div className="col-lg-5 ms-auto">
                                  <DropdownButton
                                    ...
                                    <Dropdown.Item href="/test">
                                      <i class="bi bi-journal-check"> &nbsp;</i>
                                      Test
                                    </Dropdown.Item>
                                    <Dropdown.Item href="/survey">
...
export default AdmEditcourseForm;
