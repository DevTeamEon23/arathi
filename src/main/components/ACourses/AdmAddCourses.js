...
// import profile from "../../../assets/profile/coursessss.jpg";
import {
  Dropdown,
  DropdownButton,
  ButtonGroup,
...
const AdmAddCourses = () => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
      ...
      fetch('https://localhost:8001/courses', {
        method: 'POST',
      })
      .then((data) => {
...
const fetchCategory = () => {
  fetch(`https://localhost:8001/categories`)
        .then((res) => res.json())
        .then((data) => {
           console.log(data);
           setCategory(data);
        ...
        <div className="col-lg-12">
          <div className="card">
            ...
            <div className="card-body">
              ...
              <form action="https://localhost:8001/courses" method="post" encType="multipart/form-data" >
                  <div className="row">
                  ...
                  <div className="input-group mb-3  input-success">
                      ...
                      <input type="text" className="form-control" placeholder=" https://youtube.com" id="courselink" name="courselink" 
                    ...
                    <input className="form-control form-control-lg" id="coursevideo" type="file" name="coursevideo"
                      ...
                      <Button onClick={() => history.goBack()} className="btn btn-light">Cancel</Button></div>
                        ...
                        <DropdownButton
                          ...
                          className="me-1 mt-1"
                        >
                          <Dropdown.Item href="/adm_content"><i class="bi bi-back"> &nbsp;</i>Content</Dropdown.Item>
                          <Dropdown.Item href="/adm_webcontent"><i class="bi bi-cloud"> &nbsp;</i>Web Content</Dropdown.Item>
                          <Dropdown.Item href="/adm_video"><i class="bi bi-play-circle"> &nbsp;</i>Video</Dropdown.Item>
                          <Dropdown.Item href="/adm_audio"><i class="bi bi-file-music"> &nbsp;</i>Audio</Dropdown.Item>
                          <Dropdown.Item href="/adm_presentation"><i class="bi bi-file-slides"> &nbsp;</i>Presentation | Documents</Dropdown.Item>
                          <Dropdown.Item href="/adm_scorm"><i class="bi bi-command"> &nbsp;</i>SCORM | xAPI | cmi5</Dropdown.Item>
                          <Dropdown.Item href="/adm_iframe"><i class="bi bi-code-slash"> &nbsp;</i>iFrame</Dropdown.Item>
                          <Dropdown.Item href="/adm_test-question"><i class="bi bi-journal-check"> &nbsp;</i>Test</Dropdown.Item>
                          <Dropdown.Item href="/adm_survey-question"><i class="bi bi-check2-square"> &nbsp;</i>Survey</Dropdown.Item>
                          <Dropdown.Item href="/adm_assignment"><i class="bi bi-clipboard"> &nbsp;</i>Assignment</Dropdown.Item>
                          <Dropdown.Item href="/adm_instructor-led"><i class="bi bi-calendar4-week"> &nbsp;</i>Instructor-led training</Dropdown.Item>
                        ...
                        <DropdownButton
                          ...
                          className="me-1 mt-1"
                        >
                          <Dropdown.Item href="adm_message_users"><i class="bi bi-chat-right-text"> &nbsp;</i>Message Users</Dropdown.Item>
                          <Dropdown.Item href="adm_ad_event"><i class="bi bi-calendar4-week"> &nbsp;</i>Add Event</Dropdown.Item>
