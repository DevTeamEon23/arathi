          ...
          <div className="card">
            ...
            <div className="card-body">
              <div className="form-validation">
                <form
                  action="https://localhost:8001/courses"
                  method="post"
                  ...
                  <div className="form-group mb-3 row">
                    ...
                    <div className="col-lg-5 ms-auto">
                      <DropdownButton
                        ...
                        title="ADD"
                        className="me-1 mt-1">
                        <Dropdown.Item href="/adm_content">
                          <i className="bi bi-back"> &nbsp;</i>Content
                        </Dropdown.Item>
                        <Dropdown.Item href="/adm_webcontent">
                          <i className="bi bi-cloud"> &nbsp;</i>Web Content
                        </Dropdown.Item>
                        <Dropdown.Item href="/adm_video">
                          <i className="bi bi-play-circle"> &nbsp;</i>Video
                        </Dropdown.Item>
                        <Dropdown.Item href="/adm_audio">
                          <i className="bi bi-file-music"> &nbsp;</i>Audio
                        </Dropdown.Item>
                        <Dropdown.Item href="/adm_presentation">
                          <i className="bi bi-file-slides"> &nbsp;</i>
                          Presentation | Documents
                        </Dropdown.Item>
                        <Dropdown.Item href="/adm_scorm">
                          <i className="bi bi-command"> &nbsp;</i>SCORM | xAPI |
                          cmi5
                        </Dropdown.Item>
                        <Dropdown.Item href="/adm_iframe">
                          <i className="bi bi-code-slash"> &nbsp;</i>iFrame
                        </Dropdown.Item>
                        <Dropdown.Item href="/adm_test-question">
                          <i className="bi bi-journal-check"> &nbsp;</i>Test
                        </Dropdown.Item>
                        <Dropdown.Item href="/adm_survey-question">
                          <i className="bi bi-check2-square"> &nbsp;</i>Survey
                        </Dropdown.Item>
                        <Dropdown.Item href="/adm_assignment">
                          <i className="bi bi-clipboard"> &nbsp;</i>Assignment
                        </Dropdown.Item>
                        <Dropdown.Item href="/adm_instructor-led">
                          <i className="bi bi-calendar4-week"> &nbsp;</i>
                          Instructor-led training
                        </Dropdown.Item>
                        <Dropdown.Item href="#">
                          <i className="bi bi-tropical-storm"> &nbsp;</i>Section
                        </Dropdown.Item>
                        <Dropdown.Item href="#">
                          <i className="bi bi-vr"> &nbsp;</i>Clone from another
                          course
                        </Dropdown.Item>
                        <Dropdown.Item href="#">
                          <i className="bi bi-link"> &nbsp;</i>Link from another
                          course
                        </Dropdown.Item>
                      </DropdownButton>
                      <button
                      ...
                      <DropdownButton
                        ...
                        title="..."
                        className="me-1 mt-1">
                        <Dropdown.Item href="adm_message_users">
                          <i className="bi bi-chat-right-text"> &nbsp;</i>
                          Message Users
                        </Dropdown.Item>
                        <Dropdown.Item href="adm_ad_event">
                          <i className="bi bi-calendar4-week"> &nbsp;</i>Add
                          Event
                        </Dropdown.Item>
                        <Dropdown.Item href="#">
                          <i className="bi bi-cloud-snow-fill"> &nbsp;</i>Make
                          Course Public
                        </Dropdown.Item>
                        <Dropdown.Item href="#">
