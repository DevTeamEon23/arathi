		...
		<>
					...
					<div className="card  course-dedails-bx">
						...
						<div className="card-body pt-0">
							<div className="description">
								<p>Here You learn and grow exactly how you would on a real job. You will start from the fundamentals, receive support from our mentors and community, and build your way to the top - through professional work-like Full-stack and Backend web development projects.</p>
				...
				<div className="col-xl-5">
					<div className="card">
						...
						<div className="card-footer d-flex border-0 pt-0">
							...
							<Link to={"./ecom-checkout"} className="btn btn-primary btn-md w-50 ms-2">Buy Now</Link>
						</div>
					</div>
				</div>
			</div>
			...
			<div className="pagination-down">
				<div className="d-flex align-items-center justify-content-between flex-wrap">
					...
					<ul>
						<li><Link to={"./adm_courses"}><i className="fas fa-chevron-left"></i></Link></li>
						<li><Link to={"./adm_courses"}>1</Link></li>
						<li><Link to={"./adm_course-details-1"}className="active">2</Link></li>
						<li><Link to={"./adm_course-details-2"}>3</Link></li>
						<li><Link to={"./adm_course-details-2"}><i className="fas fa-chevron-right"></i></Link></li>
					</ul>
				</div>
			</div>
		</>
