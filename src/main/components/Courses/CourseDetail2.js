		...
		<>
			<ol className="breadcrumb">
				<li className="breadcrumb-item active">
					<Link className="d-flex align-self-center" to={"/course-details-1"}>
			...
			{/* <div className="pagination-down">
				<div className="d-flex align-items-center justify-content-between flex-wrap">
					...
					<ul>
						<li><Link to={"./course-details-1"}><i className="fas fa-chevron-left"></i></Link></li>
						<li><Link to={"./courses"}>1</Link></li>
						<li><Link to={"./course-details-1"}>2</Link></li>
						<li><Link to={"./course-details-2"}className="active">3</Link></li>
					</ul>
				</div>
			</div> */}
		</>
