        ...
        <div className="h-80">
          <div className="row">
            <div className="col-xl-12 col-xxl-12">
              <div className="card">
                ...
                <div className="col-lg-2">
                  <Button onClick={HandleChange}>
                    <i class="bi bi-clock"></i>
                    {z ? "After a Period of Time" : "After a Period of Time"}
                  </Button>
                </div>
                {p && (
                  <div className="col-lg-4">
            ...
            <div className="row mb-3">
              ...
              <div className="col-lg-4">
                <Button variant="outline-primary btn-square">Search</Button>
              </div>
            </div>
