...
const CourseBlogData = [
	{ coloumClass:'col-sm-6',classChange:'bg-info', image: Book, imgClass:'',	title: 'Tests', number:'2', svgicon: <MyIcon />, },
	{ coloumClass:'col-sm-6',classChange:'bg-info', image: Bookmarks,	imgClass:'bookmarks', title: 'Attempts', number:'0', svgicon: <BookIcon /> },
	{ coloumClass:'col-sm-6',classChange:'bg-info', image: Check, imgClass:'',	title: 'Passed', number:'0', svgicon: <RightIcon /> },
	{ coloumClass:'col-sm-6',classChange:'bg-info', image: Progress,	imgClass:'', title: 'Average Score', number:'0', svgicon: <ProgressIcon /> },
              ...
              <Table responsive bordered className="verticle-middle">
                ...
                <tbody>
                  <tr>
                    ...
                    <td><center></center></td>
                    <td><center>-</center></td>
                    <Link to="/test-overview"><td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<i class="bi bi-graph-up"></i></td></Link>
                  </tr>
                </tbody>
              </Table>
            </Card.Body>
