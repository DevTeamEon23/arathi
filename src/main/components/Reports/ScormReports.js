...
const CourseBlogData = [
	{ coloumClass:'col-sm-6',classChange:'bg-info', image: Book, imgClass:'',	title: 'Scorms', number:'2', svgicon: <MyIcon />, },
    ...
    <Fragment>
      <Row>
        <Col lg={12}>
          <Card>
            <Card.Header>
              <Card.Title>Scorm Reports</Card.Title>
            </Card.Header>
            <Card.Body>
            <div className="row">
