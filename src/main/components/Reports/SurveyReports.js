...
const CourseBlogData = [
	{ coloumClass:'col-sm-6',classChange:'bg-info', image: Book, imgClass:'',	title: 'Survey', number:'2', svgicon: <MyIcon />, },
	{ coloumClass:'col-sm-6',classChange:'bg-info', image: Bookmarks,	imgClass:'bookmarks', title: 'Initiations', number:'0', svgicon: <BookIcon /> },
	{ coloumClass:'col-sm-6',classChange:'bg-info', image: Check, imgClass:'',	title: 'Passed', number:'0', svgicon: <RightIcon /> },
	{ coloumClass:'col-sm-6',classChange:'bg-info', image: Progress,	imgClass:'', title: 'Average duration', number:'0', svgicon: <ProgressIcon /> },
    ...
    <Fragment>
      <Row>
        <Col lg={12}>
          <Card>
            <Card.Header>
              <Card.Title>Survey Reports</Card.Title>
            </Card.Header>
            <Card.Body>
            <div className="row">
              ...
              <Table responsive bordered className="verticle-middle">
                ...
                <tbody>
                  <tr>
                    ...
                    <td><center>-</center></td>
                    <center><Link to="/survey-overview"><td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<i class="bi bi-graph-up"></i></td></Link></center>
                  </tr>
                </tbody>
              </Table>
            </Card.Body>
