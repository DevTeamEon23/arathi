...
import Progress from '@images/vector/Progress_3.png';
...
function ProgressIcon(){
	return(
		<>
    <svg width="23" height="23" id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 42.03 58.01">
    <path d="M3339.73 59.52a2.08 2.08 0 0 0-.45-1.42 2.13 2.13 0 0 0-1.28-.78c-.24-.06-.37-.08-.37-.36-.22-7.46-3.93-13.15-9.88-17.7-.74-.57-1.54-1.08-2.34-1.6a5 5 0 0 1-1.87-6.89 5.08 5.08 0 0 1 1.87-1.84 26.77 26.77 0 0 0 9.81-10.09 19.41 19.41 0 0 0 2.39-9.09c0-.34.13-.42.45-.51a2.07 2.07 0 0 0 1.66-2.11V4.69c0-.3-.08-.42-.39-.38h-40.85c-.59 0-.78.13-.74.7.06.75 0 1.51 0 2.25a2 2 0 0 0 1.72 2c.25 0 .37.06.38.35.21 7.38 3.86 13 9.72 17.59.81.62 1.68 1.18 2.55 1.74a5 5 0 0 1 0 8.66 26.82 26.82 0 0 0-9.91 10.31 19.74 19.74 0 0 0-2.33 8.92c0 .27 0 .41-.39.47a2 2 0 0 0-1.23.68 2.06 2.06 0 0 0-.48 1.32v2.51c0 .51.23.5.62.5H3339c.63 0 .76-.18.72-.72S3339.74 60.2 3339.73 59.52Zm-26-35.18a21.59 21.59 0 0 1-7.62-7.86h25.09a1.32 1.32 0 0 1-.3.63 22.64 22.64 0 0 1-7.73 7.56 9.26 9.26 0 0 0-4.4 6l-.14-.08a.37.37 0 0 1-.07-.14 9.75 9.75 0 0 0-1.77-3.54 9.92 9.92 0 0 0-3-2.57Zm-9.55 30.09a6.41 6.41 0 0 1 2.46-3.31 23.29 23.29 0 0 1 7.42-3.54c1.86-.58 3.67-1.22 4.69-3.07a5.27 5.27 0 0 0 2.72 2.4 17.77 17.77 0 0 0 2.32.82 22 22 0 0 1 7.25 3.58 6.35 6.35 0 0 1 2.27 3.15Z" fill="var(--primary)" transform="translate(-3297.74 -4.31)"/>
    </svg>
		</>
	)
}
...
const CourseBlogData = [
	{ coloumClass:'col-sm-6',classChange:'bg-info', image: Book, imgClass:'',	title: 'ILT', number:'2', svgicon: <MyIcon />, },
	{ coloumClass:'col-sm-6',classChange:'bg-info', image: Bookmarks,	imgClass:'bookmarks', title: 'Registration', number:'0', svgicon: <BookIcon /> },
	{ coloumClass:'col-sm-6',classChange:'bg-info', image: Check, imgClass:'',	title: 'Passed', number:'0', svgicon: <RightIcon /> },
	{ coloumClass:'col-sm-6',classChange:'bg-info', image: Progress,	imgClass:'', title: 'Average Grade', number:'0', svgicon: <ProgressIcon /> },
	{ coloumClass:'col-sm-6',classChange:'bg-info', image: Bulb, imgClass:'bulb',	title: 'Last activity', number:'0h0m', svgicon: <BulbIcon /> }
];
    ...
    <Fragment>
      <Row>
        <Col lg={12}>
          <Card>
            <Card.Header>
              <Card.Title>Ilt Reports</Card.Title>
            </Card.Header>
            <Card.Body>
            <div className="row">
        ...
        <div className={`dlab-cource ${item.classChange}`}>
          ...
          <img src={item.image} alt="" className={item.imgClass} />
              ...
              <Table responsive bordered className="verticle-middle">
                ...
                <tbody>
                  <tr>
                    <td><center>Using Assessments</center></td>
                    <td><center>Advanced Features of LMS</center></td>
                    <td><center></center></td>
                    <td><center></center></td>
                    <td><center></center></td>
                    <center><Link to="/reports-overview"><td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<i class="bi bi-graph-up"></i></td></Link></center>
                  </tr>
                </tbody>
              </Table>
            </Card.Body>
