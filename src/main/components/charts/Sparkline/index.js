      ...
      <Row>
        ...
        <Col xl={6} lg={6}>
          <Card>
            ...
            <Card.Body>
              <Sparklines data={sampleData}>
                <SparklinesLine color="#ff6a59"  />
                <SparklinesReferenceLine type="mean" color="#ff6a59 "/>
              </Sparklines>
            </Card.Body>
          </Card>
        </Col>
        ...
        <Col xl={6} lg={6}>
          <Card>
            ...
            <Card.Body>
              <Sparklines data={sampleData}>
                <SparklinesLine color="#ff6a59"  style={{ fill: "none" }} />
                <SparklinesSpots />
              </Sparklines>
            </Card.Body>
          </Card>
        ...
        <Col xl={6} lg={6}>
          <Card>
            ...
            <Card.Body>
              <Sparklines data={sampleData}>
                <SparklinesLine color="#ff6a59 " />
                <SparklinesSpots style={{ fill: "#ff6a59 " }} />
              </Sparklines>
            </Card.Body>
          </Card>
        </Col>
		<Col xl={6} lg={6}>
          <Card>
            ...
            <Card.Body>
              <Sparklines data={sampleData} >
				<SparklinesBars style={{ fill: '#ff6a59', fillOpacity: ".6" }} />
				<SparklinesReferenceLine />
			</Sparklines>
            </Card.Body>
          </Card>
        ...
        <Col xl={6} lg={6}>
          <Card>
            ...
            <Card.Body>
              ...
              >
                <SparklinesBars style={{ fill: "#ff6a59" }} />
              </Sparklines>
            </Card.Body>
          </Card>
        </Col>
