				...
				<div className="col-xl-8 col-xxl-7">
					<div className="card">
						...
						<div className="card-body pt-0">
							{boxCard.map((data, index)=>(
								<div className="blog-bx row" key={index}>
									...
									<div className="col-xl-6 col-xxl-12">
										<div className="blog-content">
											...
											<span className="fs-18 font-w400"><small className="text-primary">Admin</small> - 2 January 2022</span>
										</div>
									</div>
								</div>
							))}
							<div className="pagination-down my-4">
								<div className="d-flex align-items-center justify-content-between flex-wrap">
									<h4 className="mb-sm-0 mb-3">Showing <span>1-6 </span>from <span>100 </span>data</h4>
									<ul>
				...
				<div className="col-xl-4 col-xxl-5">
					<div className="row">
						<div className="col-xl-12">
							<div className="card blog-card bg-primary">
								<div className="card-body">
									<h4 className="text-white">Contact</h4>
									<ul>
										<li>
											<span>
												<svg className="me-3" width="22" height="28" viewBox="0 0 22 28" fill="none" xmlns="http://www.w3.org/2000/svg">
										...
										<li>
											<span>
												<svg className="me-3" width="28" height="28" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
										...
										<li>
											<span>
												<svg className="me-3" width="28" height="22" viewBox="0 0 28 22" fill="none" xmlns="http://www.w3.org/2000/svg">
						...
						<div className="col-xl-12">
							<h4 className="fs-24 mb-4">FAQS</h4>
								...
								<Accordion id="accordionExample" defaultActiveKey="0">
									{FaqBlog.map((data,i)=>(
										<Accordion.Item className="card" key={i} eventKey={`${i}`}>
											<Accordion.Header as="h2" className="accordion-header border-0" id="headingOne" >
											...
											<Accordion.Collapse eventKey={`${i}`} id="collapseOne" >
												<div className="accordion-body card-body pt-0">
													<p className="fs-18 m-0">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
												</div>
											</Accordion.Collapse>  
										</Accordion.Item>
									))}
